...
| `viewConfig`  | Object | Options passed to the view constructor. Details are in the [Vega documentation](https://vega.github.io/vega/docs/api/view/#view-construction). The view config can be used to override the [`renderer`](https://vega.github.io/vega/docs/api/view/#view_renderer) (one of `"canvas"` (default) or `"svg"`), [`logLevel`](https://vega.github.io/vega/docs/api/view/#view_logLevel), and the [`loader`](https://vega.github.io/vega/docs/api/view/#view). |
