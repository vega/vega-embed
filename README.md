...
| `defaultStyle` | Boolean       | Add default stylesheet for embed actions. |
...
| `scaleFactor` | Number        | The number by which to multiply the width and height (default `1`) of the exported PNG/SVG image. |
